...
export default function EmiratsDetail() {
  return (
    <div className="w-full bg-slate-50 font-sans min-h-screen pb-16 antialiased">
      ...
      <Helmet>
            <title>Étudier aux Émirats Arabes Unis | Guide complet pour étudiants marocains | Attaleb</title>
            <meta name="description" content="Tout savoir sur les études aux Émirats Arabes Unis : universités, système LMD, équivalences et visa étudiant pour les étudiants marocains. Accompagnement Attaleb." />
          </Helmet>
      {/* 1. Header Banner */}
      <section 
