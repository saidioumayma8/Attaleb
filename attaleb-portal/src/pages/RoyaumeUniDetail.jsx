...
function RoyaumeUniDetail() {
  return (
    <div>
      <Helmet>
        <title>Étudier au Royaume-Uni | Attaleb.net</title>
        <meta name="description" content="Découvrez pourquoi le Royaume-Uni est une destination d'études internationales privilégiée pour les étudiants marocains." />
      </Helmet>
    </div>
  );
}
