      ...
      <main className="max-w-5xl mx-auto px-4 mt-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6 lg:sticky lg:top-6 self-start">
          ...
          <div className="bg-brand-blue text-white p-6 rounded-2xl shadow-sm space-y-4 text-center">
            <h4 className="font-black text-sm uppercase tracking-wide text-brand-gold">Accompagnement Canada</h4>
            <p className="text-[11px] text-slate-300 leading-relaxed font-medium">
              Attaleb.ma vous conseille et sécurise l'intégralité de vos démarches d'admission collégiale/universitaire et de permis d'études.
            </p>
            <div className="pt-2">
              <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Contactez notre consultant :</p>
