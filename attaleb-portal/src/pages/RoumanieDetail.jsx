...
export default function RoumanieDetail() {
  return (
    <div className="w-full bg-slate-50 font-sans min-h-screen pb-16 antialiased">
      ...
      <Helmet>
            <title>Étudier en Roumanie | Guide complet pour étudiants marocains | Attaleb</title>
            <meta name="description" content="Tout savoir sur les études en Roumanie : universités, système LMD, équivalences et visa étudiant pour les étudiants marocains. Accompagnement Attaleb." />
          </Helmet>
      {/* 1. Header Banner */}
      <section 
