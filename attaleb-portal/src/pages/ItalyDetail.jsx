      ...
      <main className="max-w-5xl mx-auto px-4 mt-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6 lg:sticky lg:top-6 self-start">
          ...
          <div className="bg-brand-blue text-white p-6 rounded-2xl shadow-sm space-y-4 text-center">
            <h4 className="font-black text-sm uppercase tracking-wide text-brand-gold">Prise en charge Italie</h4>
            <p className="text-[11px] text-slate-300 leading-relaxed font-medium">
              Attaleb.ma vous conseille et vous oriente vers les meilleures facultés. Nous vous guidons pas à pas de la préparation de votre dossier d'inscription jusqu'à la demande de visa.
            </p>
            <div className="pt-2">
              <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Pour postuler, appelez-nous :</p>
              <a href="tel:0645212800" className="text-sm font-black text-white block mt-0.5 tracking-wide bg-white/10 py-2 rounded-xl border border-white/10 hover:bg-white/20 transition-all">
                06 45 21 28 00
              </a>
            </div>
          </div>
