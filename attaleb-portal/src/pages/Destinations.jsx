        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {allDestinations.map((country, idx) => (
            ...
            <Link 
              ...
              key={idx} 
              className="block relative rounded-xl overflow-hidden h-44 bg-brand-blueDark border border-slate-200/60 shadow-sm group cursor-pointer transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-brand-blueDark/100 via-brand-blueDark/40 to-transparent z-10 pointer-events-none"></div>

              {/* Card Text Content */}
              <div className="absolute bottom-0 left-0 p-5 text-white w-full z-20 text-left">
