      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mt-4">
            <a href="https://web.facebook.com/M.I.C.C.org" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://www.instagram.com/attaleb.ma/?hl=en" target="_blank" rel="noopener noreferrer"
              className="w-9 h-9 rounded-full bg-slate-700/50 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-500 flex items-center justify-center transition-all duration-300 hover:scale-110">
            ...
            <a href="https://www.linkedin.com/company/attaleb-ma/" target="_blank" rel="noopener noreferrer"
